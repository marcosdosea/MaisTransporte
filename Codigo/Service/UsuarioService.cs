...
namespace Service
{
    ...
    public class UsuarioService : IUsuarioService
    {
        ...
        {
            return _context.Passageiro.Find(id);
        }
        ...
        {
            if (passageiro.dataNascimento.Year < 1000)
        ...
        /// <summary>
        /// Obtém passageiros pelo nome
        /// </summary>
        /// <param name="nome">Nome a ser buscado</param>
        /// <returns></returns>
        public IEnumerable<UsuarioDto> GetByNome(string Nome)
        {
            IQueryable<Passageiro> tb_passageiro = _context.Passageiros;
            var query = from nome in tb_passageiro
                        where Nome.StartsWith(Nome)
                        orderby Passageiro.Nome descending
